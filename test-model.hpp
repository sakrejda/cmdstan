...
public:
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        pos__ = 0U;
        context__.validate_dims("initialization", "x", "vector_d", context__.to_vec(100));
        vector_d x(100);
        for (int j1__ = 0U; j1__ < 100; ++j1__)
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        if (jacobian__)
            x = in__.vector_constrain(100,lp__);
        else
            x = in__.vector_constrain(100);
    ...
    void write_array(RNG& base_rng__,
        ...
        vector_d x = in__.vector_constrain(100);
        for (int k_0__ = 0; k_0__ < 100; ++k_0__) {
    ...
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        for (int k_0__ = 1; k_0__ <= 100; ++k_0__) {
